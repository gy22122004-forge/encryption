...
class VideoEncryptionPage extends StatefulWidget {
  const VideoEncryptionPage({super.key});

  @override
  State<VideoEncryptionPage> createState() => _VideoEncryptionPageState();
}

class _VideoEncryptionPageState extends State<VideoEncryptionPage> {
  ...
  void _encryptData() async {
    if (_selectedFileName == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please select a video to encrypt')),
      );
      return;
    }
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                _selectedFileName ?? 'Tap to select a video',
                                style: TextStyle(
                                  color: AppColors.primaryDark,
